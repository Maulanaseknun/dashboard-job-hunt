    ...
    <div>
      <div className="grid grid-cols-3 w-full gap-5">
        <div className="col-span-2 space-y-10">
          <div>
            ...
            <div className="text-gray-500 mt-3">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati unde consequatur enim a qui consequuntur, necessitatibus ex quae inventore? Quos cum aperiam debitis ad perspiciatis nihil itaque exercitationem ea optio?
              </p>
            </div>
          </div>
          <div>
        ...
        <div>
          ...
          <div className="my-10">
            <div className="text-3xl">Required Skills</div>
            <div className="space-x-5">
      ...
      <div>
        ...
        <div className="grid-cols-4 grid gap-5 mt-9">
